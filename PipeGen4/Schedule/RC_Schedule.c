    ...
    //==================================================================================
      ...
      for (px = 1; px <= Nx; px++) {
        ...
        //if (pk >= 1 && pk <= Nk ) { 
          ...
          //-------------------------------------------------------------------
          // Adjust DII for some special port partitions
          //-------------------------------------------------------------------
       ...
       if (pk >= 1 && pk <= Nk && 
        ...
        //-------------------------------------------------------------------
                    ...
                    X[0] = 3; X[1] = 0; 
                    K[0] = 2; K[1] = 1; 
                    SortedPortPriority[0] = 0;
                    SortedPortPriority[1] = 3;
                    SortedPortPriority[2] = 5;
                    SortedPortPriority[3] = 1;
                    SortedPortPriority[4] = 2;
                    SortedPortPriority[5] = 4;
                    ...
                    */
                    ...
                    PortDirectedSchedule(fp, P, MAX_PORT_NU, ASAP_slots, \
                                         ALAP_slots, X, K, SS);
                    first = 0;
                    //exit(1);
                  }
