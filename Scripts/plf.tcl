# 
# Project automation script for plf 
# 
# Created for ISE version 12.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source plf.tcl), then you can
...
#
# -jinz: Replace benchmark/pairs in the common tcl script.
# 
...
proc set_project_props {} {
   ...
   project set device "xc5vlx330"
   project set package "ff1760"
   project set speed "-2"
...
proc add_source_files {} {
   ...
   xfile add "../hw/PLF_comp.vhd"
   xfile add "../hw/PLF_top.vhd"
   xfile add "../impulse/cregister.vhd"
   xfile add "../impulse/csignal.vhd"
   xfile add "../impulse/divmod.vhd"
   xfile add "../impulse/fifo.vhd"
   xfile add "../impulse/fifo_dc.vhd"
   xfile add "../impulse/float_fast.vhd"
   xfile add "../impulse/gmem.vhd"
   xfile add "../impulse/impack.vhd"
   xfile add "../impulse/mem_if.vhd"
   xfile add "../impulse/sema.vhd"
   xfile add "../impulse/stream.vhd"
   xfile add "../impulse/stream_dc.vhd"

   # Set the Top Module as well...
   project set top "structure" "PLF_arch_sl"
...
proc create_libraries {} {
   ...
   lib_vhdl new "impulse"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/stream_dc.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/stream.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/sema.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/mem_if.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/impack.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/gmem.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/float_fast.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/fifo_dc.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/fifo.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/divmod.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/csignal.vhd"
      lib_vhdl add_file "impulse" "/share/jinz/Xilinx_synthesis/MyResearch/benchmark/pairs/export_hw/impulse/cregister.vhd"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/share/jinz/Xilinx_synthesis/benchmark/pairs/export_hw/xilinx/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "PLF_arch_sl" -process "Generate IBIS Model"
