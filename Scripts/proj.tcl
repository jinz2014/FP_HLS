...
#=================================================================== 
# jinz:  "Schedule", "Benchmark" will be replaced by the actual name
#=================================================================== 
...
proc add_source_files {} {
   ...
   xfile add "../../../vlib/MUX.v"
   xfile add "../../../vlib/Register.v"
   xfile add "../../../vlib/RegFile.v"
   xfile add "../../../vlib/counter.v"
   xfile add "../../../vlib/float.vhd"
   xfile add "../../../Modelsim/Schedule_Benchmark/Schedule_Benchmark_HDL.v"
   xfile add "../../../Modelsim/Schedule_Benchmark/Schedule_Benchmark_ROM.v"

   # Set the Top Module as well...
   project set top "Benchmark"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/share/jinz/Xilinx_synthesis/MyResearch/My_Tool/Xilinx/Benchmark/Schedule_Benchmark/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "fir16" -process "Generate IBIS Model"
